...
const ReviewUpdate = () => {
    ...
    return (
        <div className='w-11/12 mx-auto'>
            <h2 className='text-xl mdtext-xl font-extrabold text-primary text-center'>Update Form</h2>
            <h2 className='py-2 text-xl mdtext-2xl font-extrabold text-warning text-center'>The Details Of this service : <span className='text-primary'> {review.serviceName}</span> </h2>
            <div className="card z-1 mdcard-side  shadow-xl grid grid-cols-1 mdgrid-cols-2">
                <div className="card-body w-11/12 mx-auto mdw-full  bg-base-300 text-gray-200 rounded">
                ...
                <form form onSubmit={handleSub} className="card-body w-11/12 mx-auto mdw-full  bg-blue-900 rounded">
