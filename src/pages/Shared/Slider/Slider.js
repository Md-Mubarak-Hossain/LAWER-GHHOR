...
const Slider = () => {
    const bannerText = <>
        ...
        <div className="absolute  justify-end transform -translate-y-1/2 left-5  top-3/4 ml-6 pl-6 w-1/2">
            <p className='text-xl text-bold text-white'>There are many services of Legal services of  available in our Lawyer ghhor, Your quary,you can check the web</p>
        </div>
    </>
    return (
