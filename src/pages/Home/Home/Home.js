    ...
    return (
        <>
            ...
            <div className='my-6 flex flex-col  justify-center items-center w-full'>
                ...
                <p className='lg:w-1/2 text-xl mb-4 text-center'>My service of lawyer  is most great full.The people of my country proud for me.I deliver this service by web based platform.</p>
